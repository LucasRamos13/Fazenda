...
public ListagemPessoa listagem;
 ...
 public ManutencaoLactacao(java.awt.Frame parent, boolean modal, ListagemPessoa listagem) {
        super(parent, modal);
        initComponents();
   ...
   public ManutencaoLactacao(java.awt.Frame parent, boolean modal, ListagemPessoa listagem, int pk) {
        super(parent, modal);
        initComponents();
